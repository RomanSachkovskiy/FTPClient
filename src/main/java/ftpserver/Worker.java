package src.main.java.ftpserver;
...
public class Worker extends Thread {
    ...
    private String validUser = "qwerty123";
    private String validPassword = "ftpnetwork";
    ...
    public Worker(Socket client, int dataPort) {
        ...
        this.currDirectory = System.getProperty("user.dir") + "/Server storage";
